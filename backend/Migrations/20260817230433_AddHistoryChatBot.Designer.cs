...
namespace backend.Migrations
{
    ...
    [Migration("20260817230433_AddHistoryChatBot")]
    partial class AddHistoryChatBot
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("backend.Models.AiConversation", b =>
                {
                    b.Property<int>("ID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("backend.Models.AiConversationMessage", b =>
                {
                    b.Property<int>("ID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("backend.Models.AiConversationMessage", b =>
                {
                    b.HasOne("backend.Models.AiConversation", "Conversation")
                        .WithMany("Messages")
            ...
            modelBuilder.Entity("backend.Models.FileAttachment", b =>
                {
                    b.HasOne("backend.Models.TicketComment", "TicketComment")
            ...
            modelBuilder.Entity("backend.Models.TicketComment", b =>
                {
                    b.HasOne("backend.Models.TicketComment", "ParentComment")
                        .WithMany("Replies")
