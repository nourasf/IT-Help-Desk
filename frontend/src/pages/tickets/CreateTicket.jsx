  ...
  return (
    ...
    >
      ...
      >
        ...
        <span
          className="ticket-dropdown-chevron"
          aria-hidden="true"
        />
      </button>
...
function CreateTicket() {
  ...
  async function handleAnalyzeTicket() {
    ...
    if (
      ...
      setAiError(
        "Add a subject and description first."
      );
    ...
    try {
      ...
      setAiError(
        error.message ||
          "The AI assistant could not analyze this ticket."
      );
    } finally {
  ...
  function handleApplySuggestion() {
    ...
    setForm((current) => ({
      ...
      priority:
        aiAnalysis.priority.toLowerCase(),
    }));
  }
  ...
  function addFiles(fileList) {
    ...
    if (
      ...
      setAttachmentError(
        "All attachments together cannot exceed 20 MB."
      );
  ...
  async function handleSubmit(event) {
    ...
    if (attachmentError) {
      setErrorMessage(
        "Please fix the attachment problem before sending the ticket."
      );
    ...
    try {
      ...
      if (
        ...
        try {
          ...
          uploadWarning =
            ` The ticket was created, but the attachments could not be uploaded: ${uploadError.message}`;
        }
      }
    ...
    <DashboardLayout activePage="create-ticket">
      <main className="create-ticket-page">
        <section className="create-ticket-header">
          <div>
            <span className="create-ticket-label">
              Support request
            </span>
        ...
        >
          <section className="ticket-form-section">
            <div className="ticket-section-heading">
              <div className="ticket-section-icon">
                ▤
              </div>
            ...
            <div className="ticket-fields">
              ...
              <div className="ticket-field">
                ...
                <TicketDropdown
                  ariaLabel="Category"
                  value={form.category}
                  options={ticketOptions.categories.map(
                    (category) => ({
                      id: category.id,
                      value:
              ...
              <div className="ticket-field">
                ...
                <TicketDropdown
                  ariaLabel="Priority"
                  value={form.priority}
                  options={ticketOptions.priorities.map(
                    (priority) => ({
                      id: priority.id,
                      value:
                    ...
                    {selectedFiles.map(
                      (
                        ...
                        return (
                          ...
                          >
                            <div
                              className={`selected-attachment-icon ${
                                isImage
                                  ? "image"
                                  : "document"
                              }`}
                            ...
                            <span className="selected-attachment-ready">
                              Ready
                            </span>
          ...
          <aside className="ticket-ai-column">
            <section className="ticket-ai-panel">
              <div className="ai-panel-header">
                ...
                <div>
                  ...
                  <p>
                    Let SupportHub analyze
                    your issue before you
                    submit it.
                  </p>
                </div>
              </div>
            ...
            <section className="why-ai-card">
              ...
              <div className="why-ai-item">
                ...
                <div>
                  ...
                  <p>
                    Helps our agents resolve
                    your tickets quicker.
                  </p>
                </div>
              </div>
