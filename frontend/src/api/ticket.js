...
export async function getTicketFormOptions(signal) {
  const data = await request(`${API_URL}/form-options`, {
    method: "GET",
    signal,
  });
...
export async function getMyTickets() {
  return request(`${API_URL}/my-tickets`, { method: "GET" });
}

export async function getAssignmentOptions(signal) {
  const data = await request(`${API_URL}/assignment-options`, {
    method: "GET",
    signal,
  });
...
export async function assignTicket(ticketId, agentUserId) {
  return request(`${API_URL}/${ticketId}/assign`, {
    method: "POST",
...
export async function takeTicket(ticketId) {
  return request(`${API_URL}/${ticketId}/take`, { method: "POST" });
}

export async function startWork(ticketId) {
  return request(`${API_URL}/${ticketId}/start-work`, { method: "POST" });
}

export async function pauseWork(ticketId) {
  return request(`${API_URL}/${ticketId}/pause-work`, { method: "POST" });
}

export async function getTicketById(ticketId) {
  return request(`${API_URL}/${ticketId}`, { method: "GET" });
}
...
async function ticketAction(ticketId, action, note) {
  return request(`${API_URL}/${ticketId}/${action}`, {
    method: "POST",
...
export async function resolveTicket(ticketId, resolutionNotes) {
  return ticketAction(ticketId, "resolve", resolutionNotes);
}

export async function escalateTicket(ticketId, reason) {
  return ticketAction(ticketId, "escalate", reason);
}

export async function cancelTicket(ticketId, reason) {
  return ticketAction(ticketId, "cancel", reason);
}

export async function reopenTicket(ticketId, reason) {
  return ticketAction(ticketId, "reopen", reason);
}

export async function closeTicket(ticketId) {
  return request(`${API_URL}/${ticketId}/close`, { method: "POST" });
}
